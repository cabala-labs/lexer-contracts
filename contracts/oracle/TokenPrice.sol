...
//     uint256 feederPrice = tokens[_token]
//       .prices[tokens[_token].latestRound - 1]
//       .price;
...
//     require(
//       accessControl.hasRole(msg.sender, TOKENPRICE_FEEDER),
//       "feeder_only"
//     );
//     require(tokens[_token].isTokenAvaliable, "token_unavailable");
...
//     require(
//       accessControl.hasRole(msg.sender, TOKENPRICE_KEEPER),
//       "keeper_only"
//     );
